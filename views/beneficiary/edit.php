    ...
    <div class="container">
        ...
        <form method="post" action="index.php?controller=beneficiary&action=updateBeneficiary&id=<?= htmlspecialchars($beneficiary['beneficiary_id']) ?>">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="<?= htmlspecialchars($beneficiary['name']) ?>" required>
            </div>
            
            <div class="form-group">
                <label for="need">Need:</label>
                <input type="text" name="need" id="need" value="<?= htmlspecialchars($beneficiary['need']) ?>" required>
            </div>
